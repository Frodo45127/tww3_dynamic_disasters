...
if dynamic_disasters then
    ...
    -- Ranged Infantry
    error_message = dynamic_disasters:add_unit_to_army_template("norsca", "earlygame", "deco_nor_bondsmen", 4); if is_string(error_message) then out("\t\t" .. error_message); end
    error_message = dynamic_disasters:add_unit_to_army_template("norsca", "earlygame", "deco_nor_reavers", 4); if is_string(error_message) then out("\t\t" .. error_message); end
    ...
    -- Melee Infantry
    error_message = dynamic_disasters:add_unit_to_army_template("norsca", "earlygame", "deco_nor_pit", 4); if is_string(error_message) then out("\t\t" .. error_message); end
    error_message = dynamic_disasters:add_unit_to_army_template("norsca", "earlygame", "deco_nor_maidens", 4); if is_string(error_message) then out("\t\t" .. error_message); end
    error_message = dynamic_disasters:add_unit_to_army_template("norsca", "earlygame", "deco_nor_huskarls", 2); if is_string(error_message) then out("\t\t" .. error_message); end
    ...
    -- Monsters
    error_message = dynamic_disasters:add_unit_to_army_template("norsca", "earlygame", "deco_nor_valkyrie", 2); if is_string(error_message) then out("\t\t" .. error_message); end
    error_message = dynamic_disasters:add_unit_to_army_template("norsca", "earlygame", "deco_nor_hydra", 1); if is_string(error_message) then out("\t\t" .. error_message); end
    ...
    error_message = dynamic_disasters:add_unit_to_army_template("norsca", "earlygame", "deco_nor_pit", 2); if is_string(error_message) then out("\t\t" .. error_message); end
    error_message = dynamic_disasters:add_unit_to_army_template("norsca", "earlygame", "deco_nor_maidens", 4); if is_string(error_message) then out("\t\t" .. error_message); end
    error_message = dynamic_disasters:add_unit_to_army_template("norsca", "earlygame", "deco_nor_huskarls", 6); if is_string(error_message) then out("\t\t" .. error_message); end

    -- Ranged Infantry
    error_message = dynamic_disasters:add_unit_to_army_template("norsca", "earlygame", "deco_nor_reavers", 4); if is_string(error_message) then out("\t\t" .. error_message); end

    -- Monsters
    error_message = dynamic_disasters:add_unit_to_army_template("norsca", "earlygame", "deco_nor_valkyrie", 3); if is_string(error_message) then out("\t\t" .. error_message); end
    error_message = dynamic_disasters:add_unit_to_army_template("norsca", "earlygame", "deco_nor_hydra", 1); if is_string(error_message) then out("\t\t" .. error_message); end
    ...
    --[[
    -- TODO: Integrate them into the chaos templates.
    ----------------------------------------
    -- Chaos templates
    ----------------------------------------
    -- Infantry
