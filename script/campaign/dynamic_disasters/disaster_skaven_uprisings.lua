--[[
    Skaven Uprisings disaster, By Frodo45127.

    This disaster consists on sudden burst of skaven corruption on certain key regions, which end up in a full Skaven revelion. The way it's supposed to work:
        - Pick a random settlement from the list.
        - Warn about increased corruption and spawn a small rebel army.
        - If corruption passes a threshold and the army is still alive, spawn two more armies and DOW the owner of the region.
        - For each settlement taken, increase probability of Great Ascendancy to trigger.

    Conditions to trigger:
        - Player must not be a Skaven faction.
        - After turn 30.
        - Wait between triggers: 10 turns.
        - Random chance (5%) per turn.
]]
